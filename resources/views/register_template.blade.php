...
<head>
    ...
    <!-- Title  -->
    <title>TrashTech | Register</title>
    ...
    -->
        ...
        <header class="header-area clearfix">
            ...
            <div class="amado-btn-group mt-30 mb-100">
                <a href="{{route('login')}}" class="btn amado-btn mb-15 active">Login</a>
            </div>
        </header>
        <!-- Header Area End -->
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="cart_details_area mt-50 clearfix">
                            ...
                            <form class="" action="{{route('registerAct')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-5">
                                        ...
                                        <input type="password" class="form-control" name="conf_pass" placeholder="Renter password" value="" required>
                                    </div>

                                    <div class="cart-btn">
                                            <button type="submit" class="btn amado-btn w-100" name="sub">Register</button>
                                    </div>
                                </div>
                            </form>
                        </div>
